...
class ListNode:
    def __init__(self, value, prev=None, next=None):
        self.value = value # store data for the node 
        self.prev = prev # stores reference to the prev node 
        self.next = next # stores reference to the next node 
​
    """Wrap the given value in a ListNode and insert it
    after this node. Note that this node could already
    have a next node it is point to."""
    # insert the value and the function to take you to the next node 
    # insert the value and the function to take you to the next node 
...
# add classs of the double linked list which contains diffrent doubly linked list related functions
